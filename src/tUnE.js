...
(function( window ){
    ...
    var yArDs = {
        ...
        // params holder
        options: {
            noSupportCallback: null,    //  In case we don't have speech recognition support. notify the user.
            interimResults: false,      //  Check against Intermediate results
            lang: 'en-US',              //  self explanatory
            confidence: 5,              //  Global confidence for all commands
            prefix: null,               //  Prefix to start listening "Ok Glass" wise
            prefixDistance: 0,          //  Prefix distance accuracy 
        ...
        listen: function(){
            ...
            self.speechObj.onend = function(){ 
                ...
                // Restart only on ssl
                // if( location.protocol.slice(0,-1) === "https" ){
